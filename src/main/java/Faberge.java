...
public class Faberge {
    ...
    public static BigInteger height(BigInteger eggs, BigInteger tries) {
        if (BigInteger.ZERO.equals(eggs) || BigInteger.ZERO.equals(tries)) {
            return BigInteger.ZERO;
        }
        if (BigInteger.ONE.equals(eggs)) {
            return tries;
        }
        return height(eggs, tries.subtract(BigInteger.ONE)).add(height(eggs.subtract(BigInteger.ONE), tries));
    }
